...
public class RedisPoolSelector {
	...
	public RedisPoolSelector(GahAConf conf, RedisPool rpL1) throws Exception {
		this.conf = conf;
		this.rpL1 = rpL1;
		...
		case SENTINEL:
			try {
				...
				Map<String, String> l2mn = jedis.hgetAll("gaha.l2");
				...
				String stype = jedis.get("gaha.alloc.policy");
	...
	private RedisPool __lookupL2(String id) throws Exception {
		...
		try {
			String masterName = jedis.hget("gaha.l2", id);
			if (masterName != null) {
